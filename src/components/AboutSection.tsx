        ...
        <div className="grid lg:grid-cols-5 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-gray-600 text-[15px] leading-relaxed mb-5">
              This conference addresses urgent challenges at the intersection of <span className="text-[#1A56DB] font-semibold">Telemedicine</span>, <span className="text-[#059669] font-semibold">Digital Health</span> and <span className="text-[#D97706] font-semibold">AI in Healthcare</span> — from remote patient monitoring and digital therapeutics to AI-powered diagnostics and global health policies.
            </p>
          ...
          >
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
              ...
              <div className="space-y-3">
                {[
                  { icon: Calendar, text: "20 & 21 May 2026", sub: "08:00 AM – 12:00 PM IST", color: "#1A56DB" },
