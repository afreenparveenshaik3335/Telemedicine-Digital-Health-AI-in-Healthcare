...
International Conference on Telemedicine, Digital Health & AI in Healthcare
            ...
            <p className="text-sm text-gray-500">📅 20 & 21 May 2026 · Online</p>
        ...
        <div className="mt-10 pt-8 border-t border-gray-200 grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              By registering for International Conference on Telemedicine, Digital Health & AI in Healthcare, participants agree to abide by the conference guidelines and policies. 
