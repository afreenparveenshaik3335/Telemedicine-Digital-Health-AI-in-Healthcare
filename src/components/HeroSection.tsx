    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center py-16 md:py-24">
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-blue-400 to-cyan-300">Telemedicine, Digital Health & AI in Healthcare</span>
        </motion.h1>
        ...
        >
          <span className="font-bold text-white">📅 20 & 21 May 2026</span>
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <a href="https://onegrasp.com/conference-events/international-conference-on-telemedicine-digital-health-ai-in-healthcare-2/"
